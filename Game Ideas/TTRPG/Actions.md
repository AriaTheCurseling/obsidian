Every time a character acts, determine if they are ingeniør 

Most actions are considered measured by default, but a player may take a -4 penalty *before* rolling to go one step towards caution or a +4 bonus *after* rolling to go one step towards reckless.
...
Delayed - Telegraphed - The action completes on your next turn (often interuptable)
